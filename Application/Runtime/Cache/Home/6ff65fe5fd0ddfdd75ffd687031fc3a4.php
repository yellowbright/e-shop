...
<body>
<h1>
    <span class="action-span"><a href="/index.php/Home/Admin/lst">管理员列表</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 修改管理员 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form method="post" action="/index.php/Home/Admin/save/id/21" >
    <input type="hidden" name="id" value="<?php echo I('get.id'); ?>" />
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="rpassword" maxlength="60" size="40" value="" />
                </td>
            </tr>
            <tr>
