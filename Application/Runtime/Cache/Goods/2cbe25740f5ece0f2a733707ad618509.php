...
<body>
<h1>
    <span class="action-span"><a href="/index.php/Goods/Brand/add">添加</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 列表 </span>
    <div style="clear:both"></div>
</h1>
<form method="post" action="/index.php/Goods/Brand/bdel" onclick="return confilm('确认要删除么?');" name="listForm">
        ...
        <table cellpadding="3" cellspacing="1">
           ...
           <?php foreach($data as $k => $v): ?>          <tr class="ontr">
                ...
                <input name="delid[]" type="checkbox" value="<?php echo $v['id']; ?>" />
                                ...
                                <td align="center"><img width="50" src="<?php echo IMG_URL . $v['brand_logo']; ?>" /></td>
                                <td align="center">
                <a href="/index.php/Goods/Brand/save/id/<?php echo $v['id']; ?>" title="编辑">编辑</a>
                 <a onclick="return confirm('确认要删除么?');" href="/index.php/Goods/Brand/del/id/<?php echo $v['id']; ?>" title="编辑">移除</a> 
                </td>
            </tr>
            <?php endforeach; ?>            <tr>
